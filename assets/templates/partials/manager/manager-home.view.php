<?php if(isset($_GET['p'])): ?>
		...
		<?php elseif($_GET['p'] === 'view'): ?>
			<h3 class="text-center font-weight-light">View Members</h3>
			<?php  require_once($_SERVER['DOCUMENT_ROOT'].'/projects/hostel/assets/templates/partials/manager/manager-view.view.php'); ?>
		<?php else: ?>
