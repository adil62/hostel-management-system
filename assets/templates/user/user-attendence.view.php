...
<body>
	<?php require_once($_SERVER['DOCUMENT_ROOT']."/projects/hostel/assets/templates/partials/user-nav.view.php"); ?>
<!-- <div class="container-fluid" style="border: 2px solid black;"> -->
<div class="wrapper">
	<?php require_once ($_SERVER['DOCUMENT_ROOT']."/projects/hostel/assets/templates/partials/user-sidebar.view.php");?>
		<section>
		<!--  include user ATTENDENCE Partials -->
		<?php require_once($_SERVER['DOCUMENT_ROOT']."/projects/hostel/assets/templates/partials/user-attendence.view.php"); ?>
		</section>
</div>
